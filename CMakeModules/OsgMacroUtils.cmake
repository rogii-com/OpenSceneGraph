...
MACRO(LINK_CORELIB_DEFAULT CORELIB_NAME)
    ...
    IF(OPENSCENEGRAPH_SONAMES)
      SET_TARGET_PROPERTIES(${CORELIB_NAME} PROPERTIES VERSION ${OPENSCENEGRAPH_VERSION} SOVERSION ${OPENSCENEGRAPH_VERSION})
...
MACRO(SETUP_LIBRARY LIB_NAME)
    ...
    ENDIF()
        ...
        SETUP_RPATH_LINK(${LIB_NAME})
        SET_TARGET_PROPERTIES(${LIB_NAME} PROPERTIES FOLDER "OSG Core" PREFIX "")
        IF(APPLE)
...
#the installation path are differentiated for win32 that install in bib versus other architecture that install in lib${LIB_POSTFIX}/${OSG_PLUGINS}
    IF(WIN32)
        ...
        install(
            FILES
                $<TARGET_PDB_FILE:${TARGET_TARGETNAME}>
            DESTINATION
                bin/${OSG_PLUGINS}
            COMPONENT
